% function [f_lm, freq, m_lm, module, w_lm, width] = gmodelall3(temp,yoff,state);
%
...
%       state = "A" or "B" or not included in call, then OPT
%
%     Outputs:
...
%  
%     Required files:
%        finalgm.mat:            OPT grating model parameters
%        finalgm_a.mat:          A-side grating model parameters
%        finalgm_b.mat:          B-side grating model parameters
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [f_lm, freq, m_lm, module, w_lm,width] = gmodelall3(temp, yoff, varargin);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%addpath /asl/matlab/srftest
...
% What is loaded depends upon varargin, if asking for A/B state instead of
% OPT
